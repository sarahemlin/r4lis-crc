...
## Learning Objective: To create a simple flexdashboard to display data visualizations and tabular data. {#flexdashboard-los}
...
```{r pkgs-flexdashboard, include = FALSE}
# loading libraries
library(tidyverse)
