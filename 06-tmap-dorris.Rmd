...
stl_stops <- st_read("Metro_St._Louis_MetroBus_Stops_By_Line/Metro_St._Louis_MetroBus_Stops_By_Line.shp")
tmap_mode("view")
tm_shape(stl_stops)+
  tm_dots()
```
...
tm_shape(stl_tracts, unit = "mi") +
  tm_polygons("unemployment_rate", title = "Unemployment rate")  +
   tm_layout(title = "Percentage unemployed by\n Census tract", title.size = .7, legend.width = 1, legend.text.size = .4, legend.title.size = .5, legend.position = c("left", "top"),
